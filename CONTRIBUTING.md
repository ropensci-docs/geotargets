...
This outlines how to propose a change to geotargets. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("njtierney/geotargets", fork = TRUE)`.
...
Code of
Conduct](https://docs.ropensci.org/geotargets/CODE_OF_CONDUCT.md). By
